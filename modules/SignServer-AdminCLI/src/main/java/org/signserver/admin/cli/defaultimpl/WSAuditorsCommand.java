 ...
 *
 * @version $Id: WSAuditorsCommand.java 5211 2014-09-23 16:07:05Z malu9369 $
 */
public class WSAuditorsCommand extends AbstractWSClientsCommand {
    ...
    private static final String USAGE =
            ...
            + "Example 3: signserver wsauditors -remove -certserialno 123ABCDEF -issuerdn \"CN=Neo Morpheus, C=SE\"\n"
