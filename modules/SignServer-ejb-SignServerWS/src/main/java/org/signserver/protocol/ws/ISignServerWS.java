 ...
 * @version $Id: ISignServerWS.java 1865 2011-09-27 13:22:17Z anatom $
 */
public interface ISignServerWS {

    final String ALLWORKERS = "ALLWORKERS";
     ...
     */
    Collection<WorkerStatusWS> getStatus(String workerIdOrName) throws InvalidWorkerIdException;
     ...
     */
    Collection<ProcessResponseWS> process(String workerIdOrName, Collection<ProcessRequestWS> requests)
