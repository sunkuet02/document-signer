 ...
 * 
 * @author Markus Kilås
 * @version $Id: XMLValidatorTestData.java 5481 2014-11-27 08:06:41Z netmackan $
 */
public class XMLValidatorTestData {
    ...
    /**
     * Ok sig, ok cert but with DOCTYPE.
     */
    public static final String TESTXML1_WITH_DOCTYPE =
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
            +"<!DOCTYPE foo [\n"
            +"  <!ELEMENT foo ANY >\n"
            +"]>"
