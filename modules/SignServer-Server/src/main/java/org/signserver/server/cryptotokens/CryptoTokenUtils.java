 ...
 * @version $Id: CryptoTokenUtils.java 3718 2013-08-18 15:55:09Z netmackan $
 */
public final class CryptoTokenUtils {
     ...
     * 
     * FIXME: Rename method to follow the naming convention.
     * 
     * @param store
     *            p12 keystore path
     * @param sPass
    ...
    public static String CreateKeyDataForSoftCryptoToken(String store,
        ...
        if (ks.containsAlias(alias)) {
            ...
            if (key instanceof PrivateKey) {
                ...
                return new String(Base64.encode(bos.toByteArray(), false)).replace("=", "\\=");
