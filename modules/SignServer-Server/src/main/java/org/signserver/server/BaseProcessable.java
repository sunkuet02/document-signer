...
public abstract class BaseProcessable extends BaseWorker implements IProcessable, IKeyRemover {
    ...
    private static class WrappedCryptoToken implements ICryptoToken, ICryptoTokenV2 {
        ...
        public Certificate generateSignerKeyAndGetCertificate(String keyAlgorithm, String keySpec, String alias, char[] authCode) throws CryptoTokenOfflineException, IllegalArgumentException, KeyStoreException {
            return delegate.generateSignerKeyAndGetCertificate(keyAlgorithm, keySpec, alias, authCode);
        }
        @Override
    ...
    private static class WrappedCryptoTokenV3 extends WrappedCryptoToken implements ICryptoTokenV3 {
        ...
        public Certificate generateSignerKeyAndGetCertificate(String keyAlgorithm, String keySpec, String alias, char[] authCode, Map<String, Object> params, IServices services) throws TokenOutOfSpaceException, CryptoTokenOfflineException, DuplicateAliasException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, UnsupportedCryptoTokenParameter {
            return delegate.generateSignerKeyAndGetCertificate(keyAlgorithm, keySpec, alias, authCode, params, services);
        }
    ...
    @Override
    public Certificate generateSignerKeyAndGetCertificate(final String keyAlgorithm, final String keySpec,
                            final String alias, final char[] authCode) throws
            CryptoTokenOfflineException,
            DuplicateAliasException,
            NoSuchAlgorithmException,
            InvalidAlgorithmParameterException,
            UnsupportedCryptoTokenParameter, KeyStoreException {
        return generateSignerKeyAndGetCertificate(keyAlgorithm, keySpec, alias, authCode, Collections.<String, Object>emptyMap(), new ServicesImpl());
    }

    public Certificate generateSignerKeyAndGetCertificate(final String keyAlgorithm, final String keySpec, final String alias, final char[] authCode, Map<String, Object> params, final IServices services) throws
            CryptoTokenOfflineException,
            DuplicateAliasException,
            NoSuchAlgorithmException,
            InvalidAlgorithmParameterException,
        ...
        try {
            ...
            if (token == null) {
                ...
                certificate = ((ICryptoTokenV3) token).generateSignerKeyAndGetCertificate(keyAlgorithm, keySpec, alias,
                        authCode, params, services);
            } else if (token instanceof IKeyGenerator) {
                certificate = ((IKeyGenerator) token).generateSignerKeyAndGetCertificate(keyAlgorithm, keySpec, alias, authCode);
            } else {
                throw new IllegalArgumentException(
                        "Key generation not supported by crypto token");
            }
