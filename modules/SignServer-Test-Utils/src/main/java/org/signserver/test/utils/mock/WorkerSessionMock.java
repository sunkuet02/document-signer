 ...
 *
 * @author Markus Kilås
 * $version $Id: WorkerSessionMock.java 6061 2015-06-01 11:33:44Z netmackan $
 */
public class WorkerSessionMock implements IWorkerSession.ILocal,
    ...
    @Override
    public Certificate generateSignerKeyAndGetCertificate(int signerId, String keyAlgorithm, String keySpec, String alias, char[] authCode) throws CryptoTokenOfflineException, InvalidWorkerIdException {
        return null;
    }
    ...
    @Override
    public void uploadSignerCertFromCrytoWorkerCert(int signerId, int cryptoTokenID, String scope) throws CertificateException, CryptoTokenOfflineException {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public void uploadSignerCertChainFromCrytoWorkerCert(int signerId, int cryptoTokenID, String scope) throws CertificateException, CryptoTokenOfflineException {
        throw new UnsupportedOperationException("Not supported yet.");
    }
