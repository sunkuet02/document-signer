 ...
 *
 * @version $Id: CommandLineInterface.java 2097 2012-02-07 15:14:11Z netmackan $
 */
public class CommandLineInterface {
    ...
    public int createWorker(final String... args) throws UnexpectedCommandFailureException {
        int resultCode;
        ...
        if (cmd != null) {
            try {
                ...
                // Run with args without the name of the command and sub command
                return cmd.execute(Arrays.copyOfRange(args, shift, args.length));
            } catch (IllegalCommandArgumentsException ex) {
                out.println(ex.getMessage());
                out.println(cmd.getUsages());
                resultCode = RETURN_INVALID_ARGUMENTS;
