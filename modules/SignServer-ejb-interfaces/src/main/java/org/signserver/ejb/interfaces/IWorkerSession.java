 ...
 *
 * @version $Id: IWorkerSession.java 5978 2015-03-27 15:34:04Z netmackan $
 */
public interface IWorkerSession {
    ...
    Certificate generateSignerKeyAndGetCertificate(int signerId, String keyAlgorithm,
                             String keySpec, String alias, char[] authCode)
            throws CryptoTokenOfflineException, InvalidWorkerIdException, KeyStoreException;
    /**
    ...
    void uploadSignerCertFromCrytoWorkerCert(int signerId, int cryptoTokenID,
                                        String scope) throws CertificateException, CryptoTokenOfflineException;

    void uploadSignerCertChainFromCrytoWorkerCert(int signerId, int cryptoTokenID,
                                             String scope) throws CertificateException, CryptoTokenOfflineException;
