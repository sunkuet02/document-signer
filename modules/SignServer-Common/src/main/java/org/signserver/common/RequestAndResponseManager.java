 ...
 * @version $Id: RequestAndResponseManager.java 3961 2014-01-02 13:19:02Z netmackan $
 */
public class RequestAndResponseManager {
    ...
    public static final int REQUESTTYPE_BULKSODSIGNREQUEST= 4;
    ...
    public static final int RESPONSETYPE_BULKSODSIGNRESPONSE = 4;
